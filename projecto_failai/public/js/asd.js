                  ...
                  value: function (e, t) {
                    ...
                    if (
                      ...
                      var r = this.wavesurfer.getDuration(),
                        ...
                        n =
                          Math.max(0, ((e - this.wrapper.scrollLeft) / s) * r) +
                          a,
                        l = this.formatTime(n);
                      i &&
                        (e -= this.displayTime.getBoundingClientRect().width),
